...
use App\Http\Controllers\KittyGroupAPIController;
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/inventory', [ProductController::class, 'inventoryIndex']);
    ...
    Route::prefix('kitties')->group(function () {
        Route::get('/kitties', [KittyGroupAPIController::class, 'index'])->name('kitties.index');
        Route::get('/create', [KittyGroupAPIController::class, 'create'])->name('kitties.create');
        // Route to create a new kitty group with members
        Route::post('/store', [KittyGroupAPIController::class, 'store'])->name('kitties.store');
        Route::get('/get-customers-list', [KittyGroupAPIController::class, 'getCustomersList']);
        Route::get('/group/{id}/installments', [KittyGroupAPIController::class, 'fetchKittyGroupInstallments'])->name('kitties.installments');
        Route::post('/group/{id}/winner', [KittyGroupAPIController::class, 'selectedWinnerCreate'])->name('kitties.winner');
        Route::post('{id}/installment/payment-status',[KittyGroupAPIController::class, 'changePaymentStatus'])->name('kitties.paymentStatus');
        
        // Route to get details of a specific kitty group
        Route::get('/{id}', [KittyGroupAPIController::class, 'show'])->name('kitties.show');
        Route::get('/edit/{id}', [KittyGroupAPIController::class, 'edit'])->name('kitties.edit');
        Route::delete('/{id}', [KittyGroupAPIController::class, 'destroy'])->name('kitties.destroy');
        Route::post('/update/{id}', [KittyGroupAPIController::class, 'update'])->name('kitties.update');
        Route::get('/customers', [KittyGroupAPIController::class, 'fetchCustomers'])->name('kitties.customers');
        Route::post('/groups/{id}/draw', [KittyGroupAPIController::class, 'monthlyDraw'])->name('kitties.monthlyDraw');
    });
});
