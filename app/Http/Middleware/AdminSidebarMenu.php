...
class AdminSidebarMenu
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        Menu::create('admin-sidebar-menu', function ($menu) {
            ...
            array_push($enabled_modules, 'accounts');
                ...
                $menu->dropdown(
                    ...
                    function ($sub) {
                        ...
                        $sub->url(
                          ...
                          $sub->url(
                            action([\App\Http\Controllers\ProductController::class, 'inventoryIndex']),
                            __('Inventory'),
                            ['icon' => '', 'active' => request()->segment(1) == 'inventory']
                        );
                    },
                    [
                        'icon' => '<svg aria-hidden="true" class="tw-size-5 tw-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            // if (in_array('account', $enabled_modules)) {
                $menu->dropdown(
                    ...
                    function ($sub) {
                        ...
                        $sub->url(
                            action([\App\Http\Controllers\KittyGroupAPIController::class, 'index']),
                            __('kitties.list_kitties'),
                            ['icon' => '', 'active' => request()->segment(1) == 'kitties' && request()->segment(2) == 'kitties']
                        );
                    },
                    [
                        'icon' => '<svg aria-hidden="true" class="tw-size-5 tw-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
